...
import Submissions from './admin/components/Submissions'
...
window.petitionerData = editorContainer.dataset?.avPtrInfo ? JSON.parse(editorContainer.dataset.avPtrInfo) : {};
