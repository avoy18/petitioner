...
import { ClipboardButton, BaseControl, TextControl } from '@wordpress/components';
...
export default function ShortCodeArea() {
    ...
    return <p style={{
        ...
        <BaseControl
            help="Use this shortcode on the frontend of your website to show the petition form"
        >
