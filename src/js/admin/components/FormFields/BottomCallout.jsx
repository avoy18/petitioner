...
export default function BottomCallout() {
	return (
		<section className="petitioner-callout-box">
			...
			<p>
				Hi! I’m Anton, the creator of this plugin. I truly appreciate
				you giving it a try and hope it makes your work easier. If
				you're enjoying it, I’d be super grateful if you left a review!
			</p>
			<p>
