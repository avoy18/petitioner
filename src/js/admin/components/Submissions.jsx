...
export default function Submissions() {
    ...
    const [showApproval, setShowApproval] = useState(window.petitionerData.require_approval);
    const [defaultApprovalState, setDefaultApprovalState] = useState(window.petitionerData.approval_state);
    ...
    const ApprovalStatus = ({ id, currentStatus = '' }) => {
        currentStatus = currentStatus?.length > 0 ? currentStatus : defaultApprovalState;
        ...
        return <div>
            ...
            <Button
                ...
                variant="secondary"
                onClick={() => {
                    handleStatusChange(id, currentStatus === 'Confirmed' ? 'Declined' : 'Confirmed', changeAction.toLowerCase());
                }}
            >
                {changeAction}
            </Button>
