  ...
  constructor(petitionForm) {
    if (typeof window.petitionerCaptcha !== "undefined" && window.petitionerCaptcha.recaptchaSiteKey) {
      ...
      petitionForm.addEventListener(
        ...
        function() {
          var _a;
          if (recaptchaField && (recaptchaField == null ? void 0 : recaptchaField.value)) {
            return;
          }
          if (typeof window.grecaptcha === "undefined" || typeof ((_a = window.grecaptcha) == null ? void 0 : _a.ready) === "undefined") {
            return;
          }
          window.grecaptcha.ready(function() {
            var _a2, _b;
            (_b = window.grecaptcha) == null ? void 0 : _b.execute(((_a2 = window.petitionerCaptcha) == null ? void 0 : _a2.recaptchaSiteKey) || "", {}).then((token) => {
              if (recaptchaField) {
...
class PetitionerForm {
  ...
  showResponseMSG(messaging, isSuccess = false) {
    var _a;
    (_a = this.wrapper) == null ? void 0 : _a.classList.add("petitioner--submitted");
  ...
  shouldValidateHCaptcha() {
    var _a;
    return !!(((_a = window.petitionerCaptcha) == null ? void 0 : _a.enableHcaptcha) && this.hcaptcha && !this.captchaValidated);
  }
  shouldValidateTurnstile() {
    var _a;
    return !!(((_a = window.petitionerCaptcha) == null ? void 0 : _a.enableTurnstile) && this.turnstile && !this.captchaValidated);
  }
  async submitForm() {
    var _a;
  ...
  async getFreshNonce() {
    ...
    try {
      ...
      if (data.success && ((_a = data.data) == null ? void 0 : _a.nonce)) {
