(function () {
	...
	var toString$6 = uncurryThis$r({}.toString);
	var stringSlice$2 = uncurryThis$r(''.slice);
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$3(globalThis$u, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	...
	var toString$5 = uncurryThis$n(1.1.toString);
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$8(hiddenKeys$2, key) && hasOwn$8(O, key) && push$4(result, key);
	...
	*/
	...
	$$r({ target: 'Array', proto: true, arity: 1, forced: FORCED$6 }, {
	...
	$$q({ global: true, constructor: true, forced: FORCED$5 }, {
	...
	var createIteratorProxyPrototype = function (IS_ITERATOR) {
	  ...
	  return defineBuiltIns(create$2(IteratorPrototype), {
	    next: function next() {
	...
	$$p({ target: 'Iterator', proto: true, real: true, forced: FORCED$4 }, {
	...
	$$o({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	...
	$$n({ target: 'Iterator', proto: true, real: true, forced: FORCED$3 }, {
	...
	var slice$2 = uncurryThis$c(ArrayBufferPrototype.slice);
	...
	$$k({ target: 'Iterator', proto: true, real: true, forced: everyWithoutClosingOnEarlyError }, {
	...
	$$j({ target: 'Iterator', proto: true, real: true, forced: findWithoutClosingOnEarlyError }, {
	...
	$$g({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$2(getIteratorDirect$1(anObject$2(this)), push$2, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	var forEach = uncurryThis$a(SetPrototype.forEach);
	...
	$$8({ global: true, constructor: true, arity: 3, forced: PATCH }, {
