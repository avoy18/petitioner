...
define('AV_PETITIONER_PLUGIN_VERSION', '0.8.7');
...
if (file_exists(AV_PETITIONER_PLUGIN_DIR . 'vendor/woocommerce/action-scheduler/action-scheduler.php')) {
...
require_once AV_PETITIONER_PLUGIN_DIR . 'inc/submissions/class-csv-importer.php';
...
require_once AV_PETITIONER_PLUGIN_DIR . 'inc/frontend/class-submissions-ui.php';
